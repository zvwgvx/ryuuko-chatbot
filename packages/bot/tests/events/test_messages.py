...
class TestProcessAIRequest:
    ...
    @patch('bot.events.messages.send_long_message_with_reference', new_callable=AsyncMock)
    @patch('bot.events.messages._read_attachments_enhanced', new_callable=AsyncMock)
